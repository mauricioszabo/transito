...
Benchmark.benchmark do |bm|
  header '$date_time.new_offset(0).strftime(Transito::TIME_FORMAT)'
  3.times do
    bm.report do
      n.times do
  ...
  header '$date_time.to_time.utc.strftime(Transito::TIME_FORMAT)'
  3.times do
    bm.report do
      n.times do;
        $date_time.to_time.utc.strftime(Transito::TIME_FORMAT)
      end
    end
  end
  ...
  header '$time.getutc.strftime(Transito::TIME_FORMAT)'
  3.times do
    bm.report do
      n.times do
        $time.getutc.strftime(Transito::TIME_FORMAT)
      end
    end
  end
  ...
  header '$time.to_datetime.new_offset(0).strftime(Transito::TIME_FORMAT)'
  3.times do
    bm.report do
      n.times do
        $time.to_datetime.new_offset(0).strftime(Transito::TIME_FORMAT)
      end
    end
  end
  ...
  header '$date.to_datetime.strftime(Transito::TIME_FORMAT)'
  3.times do
    bm.report do
      n.times do
        $date.to_datetime.strftime(Transito::TIME_FORMAT)
      end
    end
  end
  ...
  header '$date.to_time.strftime(Transito::TIME_FORMAT)'
  3.times do
    bm.report do
      n.times do
        $date.to_time.strftime(Transito::TIME_FORMAT)
      end
    end
  end
  ...
  header 'Time.gm($date.year, $date.month, $date.day).strftime(Transito::TIME_FORMAT)'
  3.times do
    bm.report do
      n.times do
        Time.gm($date.year, $date.month, $date.day).strftime(Transito::TIME_FORMAT)
      end
    end
  end
end
...
date_time.new_offset(0).strftime(Transito::TIME_FORMAT)
